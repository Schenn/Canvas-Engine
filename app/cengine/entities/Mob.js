 ...
 */
Mob.prototype.addDirection = function (direction, spriteNames) {
 ...
 * @type {Function}
 */
Mob.prototype.setCollidable = function () {
 ...
 * @method
 */
Mob.prototype.setDirection = (function (direction, xSpeed, ySpeed) {
 ...
 * @method
 */
Mob.prototype.animateDirection = function () {
  this.setAnimationTimes();
...
Mob.prototype.setAnimationTimes = function(){
  var d = new Date();
 ...
 * @return Object
 */
Mob.prototype.clearInfo = (function () {
  return ({
 ...
 */
Mob.prototype.render = (function (canvas) {
  this.atimer.update();
  this.mtimer.update();
 ...
 * @type {Function}
 */
Mob.prototype.boundryEdgePixels = (function () {
  var pixels = [];
